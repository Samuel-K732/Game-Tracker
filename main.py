...
1. Добавление записи через интерфейс - ГОТОВО
2. Редактирование записи через интерфейс. Осталось решить проблему с изображением
3. Добавление доп функционала (светлая и темная темы, удаление записи - ГОТОВО, полное удаление всех записей - ГОТОВО)
4. Доработка стиля интерфейса
5. Решение неприятных, но незначительных проблем: 
    - мигание списков комбо бокс из-за частого обновления (after Можно вызывать ко всем обьектам!!!)
    - обновление выпадающего списка и правого фрейма после добавления новой записи - ГОТОВО
